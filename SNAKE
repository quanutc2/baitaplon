...
public:
	...
	bool kiemtra_ran_de_qua1();
	void tao_qua();
	void tao_qua1();
	void ve_qua();
	void ve_qua1();
	bool kiemtra_ran_an_qua();
	bool kiemtra_ran_an_qua1();
	void xu_ly_an_qua();
...
bool Snake::kiemtra_ran_de_qua1()
{
	for (int i = 0; i < so_luong; i++)
	{
		if (this->toa_do_xqua1 == toa_do_x[i] && this->toa_do_yqua1 == toa_do_y[i])
			return true;
	}
	return false;
}
...
void Snake::tao_qua1(){
	...
	do
	{
		toa_do_xqua1=rand() % (90 - 11 + 1) + 11;
		toa_do_yqua1=rand() % (23 - 2 + 1) + 2;
	}while(kiemtra_ran_de_qua1());
}
void Snake::ve_qua1()
{
	gotoXY(toa_do_xqua1, toa_do_yqua1);
	cout << "$";
}	
void Snake::ve_qua()
{
...
bool Snake::kiemtra_ran_an_qua()
{
	return (toa_do_x[0] == this->toa_do_xqua && toa_do_y[0] == this->toa_do_yqua);
	
}
bool Snake::kiemtra_ran_an_qua1()
{
	return (toa_do_x[0] == this->toa_do_xqua1 && toa_do_y[0] == this->toa_do_yqua1);
	
}

void Snake::xu_ly_an_qua()
{
	if (kiemtra_ran_an_qua()||kiemtra_ran_an_qua1())
	{
